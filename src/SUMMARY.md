...
- [비트코인의 오해와 진실](5_0_myths.md)
    ...
    - [비트코인은 아무런 가치가 없어요](5_2_bitcoin_no_value.md)
    - [비트코인은 가격 변동이 너무 심해요](5_3_bitcoin_volatility.md)
    - [비트코인은 사용성이 떨어져요](5_4_bitconi_usability.md)
    - [비트코인은 불법 활동에 사용되요](5_5_bitcoin_illegal.md)
    - [꼭 비트코인일 필요가 없어요](5_6_bitcoin_cbdc.md)
